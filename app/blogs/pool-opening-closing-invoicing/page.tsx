...
export const metadata = {
  title: 'Invoicing Pool Openings and Closings as Seasonal One-Off Jobs | PoolBossPro',
  description: 'How PoolBossPro lets pool service pros invoice seasonal pool openings and closings as one-off jobs with card-on-file payments and clean records.',
};
