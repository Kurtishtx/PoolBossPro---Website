...
export const metadata = {
  title: 'Scale a Mosquito Spray Business at Peak Season | PoolBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>PoolBossPro&apos;s waiting list surfaces overdue accounts automatically and lets you build concurrent routes for multiple crews from the same pool — so peak season runs from the software, not from memory.</p>
