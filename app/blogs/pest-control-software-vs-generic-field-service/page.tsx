...
export const metadata = {
  title: 'Pest Control Software vs Generic Field Service | PoolBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>PoolBossPro is built around the program model that pest control actually runs on — not adapted from a job-board tool with workarounds for recurring treatments.</p>
