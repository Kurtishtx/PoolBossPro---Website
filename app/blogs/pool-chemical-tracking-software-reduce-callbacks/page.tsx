...
export const metadata = {
  title: 'How Pool Chemical Tracking Software Cuts Cloudy-Water Callbacks | PoolBossPro',
  description: 'See how pool chemical tracking software logs water chemistry, surfaces trends, and catches problems early to cut cloudy-water callbacks and free re-visits.',
};
