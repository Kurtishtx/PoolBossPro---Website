...
export const metadata = {
  title: 'Lawn Care Software Pricing: What to Expect | PoolBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>PoolBossPro&apos;s flat pricing means every feature is available from day one — and the cost stays constant as you add technicians, add accounts, and grow the business. No pricing traps that penalize success.</p>
