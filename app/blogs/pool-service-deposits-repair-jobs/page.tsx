...
export const metadata = {
  title: 'Collecting Deposits on Big Pool Repair Jobs Before Work Starts | PoolBossPro',
  description: 'See how PoolBossPro lets pool service pros invoice a deposit, take a card-on-file payment, and lock in big repair jobs before any work begins.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h2>Build the Quote From the Pool Profile</h2>
        <p>
          Accurate deposits start with an accurate quote, and PoolBossPro keeps every detail you need on the property profile. Before you price the job you already know the pool type, the size in gallons, and the equipment on the pad &mdash; the pump model, the filter, the heater, the salt system. When a chlorine generator finally dies, you are not guessing which cell fits; the profile tells you. That means your quote reflects the real parts and labor for that specific pool, not a rough ballpark. A quote built on solid numbers gives you the confidence to ask for a deposit, because you know the total is right and your margin is protected.
        </p>

        <h2>Invoice the Deposit and Take the Card on File</h2>
        <p>
          This is where PoolBossPro turns intention into collected cash. Generate the repair invoice, mark the deposit portion as due before work, and charge the card you already keep on file for that customer&apos;s weekly service. Many of your repair customers are existing route accounts, so the payment method is already saved &mdash; one tap and the deposit clears. For a new customer, the software sends a secure payment link by text so they can drop a card in seconds from their phone. Either way, you have money in hand before the truck rolls. The remaining balance stays on the invoice and gets charged automatically when the job is marked complete, so nothing slips through.
        </p>

        <h2>Schedule Only After the Deposit Clears</h2>
        <p>
          The cleanest way to enforce deposits is to make scheduling depend on them. In PoolBossPro you can hold the repair on the Job Board until the deposit is paid, then dispatch it to the right tech once the money lands. That keeps your route-based scheduling honest &mdash; your crew&apos;s day is filled with confirmed, paid-up work instead of maybes. When the deposit posts, the job drops onto the board, you assign it to whoever is closest on the day&apos;s routing, and the customer gets an automatic text confirming the visit window. No deposit, no slot. It is a simple rule, and the software handles it so you never have to be the bad guy.
        </p>

        <h2>Keep Repairs and Recurring Billing Straight</h2>
        <p>
          One worry pool pros have is that a one-time repair charge will tangle up with the weekly cleaning subscription. PoolBossPro keeps them separate but linked to the same account, so the customer sees a clean record: recurring service on its own cadence, repair invoices with their deposits and final balances on their own line. That clarity matters when money moves mid-cycle for any reason. The same prorating logic that helps you <a href="/blogs/prorate-mid-month-pool-customers">Prorate Mid-Month Pool Customers Without the Math Headache</a> keeps your recurring billing tidy while a big repair runs alongside it, so a customer never gets a confusing statement that mixes a green-to-clean recovery with three weeks of routine cleaning.
        </p>

        <h2>See What You Have Collected and What Is Outstanding</h2>
        <p>
          Once deposits are part of your workflow, reporting tells you whether the discipline is paying off. PoolBossPro shows you which repair jobs have deposits collected, which balances are still open, and how much revenue is committed before a single visit happens. You can spot a job that was scheduled without its deposit, see a customer whose final balance never charged, and watch your repair revenue climb next to your recurring route income. Pair that with your water chemistry logs &mdash; chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate readings tied to each pool &mdash; and you have a full picture of every account, from weekly maintenance to the biggest equipment overhaul. For more on running this side of the business, the <a href="/pool-invoicing-software">pool invoicing &amp; billing</a> tools in PoolBossPro keep every dollar accounted for from quote to final payment.
        </p>

        <div className="blog-cta-box">
          <h3>Lock in Your Next Big Repair Before It Starts</h3>
          <p>PoolBossPro lets you quote, invoice a deposit, and charge the card on file so no repair job begins until you are paid.</p>
          <a href="https://my.poolbosspro.com">Start Free Trial</a>
        </div>
        <div className="blog-keywords">Keywords: pool service software, pool repair deposits, card-on-file payments, pool invoicing software, pool maintenance billing, pool job scheduling</div>
      </article>
    </BlogShell>
  );
}
