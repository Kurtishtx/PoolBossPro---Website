...
export const metadata = {
  title: 'How Lawn Care Software Pays for Itself in 90 Days | PoolBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>PoolBossPro generates positive ROI in the first month through time savings, service recovery, route efficiency, and faster billing — at $129/month flat with every feature included.</p>
