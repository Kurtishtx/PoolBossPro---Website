  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>Service Autopilot has tiers. Route optimization is $199/month. Automations are $499/month. Two-way texting costs even more. PoolBossPro is $129/month with everything included — plus an accurate lasso, sq ft waiting list, and chemical compliance logs that SA doesn&apos;t have at any price.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">$0</div><div className="hero-stat-lbl">Sign-Up Fee for PoolBossPro</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">PoolBossPro vs Service Autopilot</h2>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>Service Autopilot Has Map Selection.<br />PoolBossPro Has an Accurate Lasso.</h2>
            <p style={{color:'rgba(255,255,255,.65)'}}>Service Autopilot has a map selection tool — but it overstates sq ft by counting each service separately. If a property has Lawn Care 4 and Mosquito scheduled, SA counts the sq ft twice. PoolBossPro counts the property sq ft once and breaks down the services separately. The difference is roughly 2x — and it matters when you&apos;re pricing and planning routes.</p>
        ...
        <div style={{maxWidth:'1100px', margin:'0 auto'}}>
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div style={{background:'linear-gradient(135deg, var(--purple-deep) 0%, #263445 100%)', borderRadius:'10px', padding:'18px', border:'2px solid rgba(13,148,136,.3)'}}>
                ...
                <div className="mock-item"><div className="mock-dot orange"></div><div><div className="mock-label">PoolBossPro</div><div className="mock-sub">Everything included — plus lasso &amp; chemical logs</div></div><div className="mock-badge">$129/mo</div></div>
              </div>
            </div>
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>Even at SA&apos;s top published tier ($499/month for Pro Plus), you&apos;re still missing the accurate lasso, sq ft waiting list by service type, and chemical compliance logs. Those don&apos;t exist in SA at any price. PoolBossPro includes everything at $129/month with no sign-up fee.</p>
      ...
      <div className="premium-band">
        ...
        <p>The features that matter most to lawn care and pest control businesses — accurate sq ft tracking, chemical compliance logs, sq ft waiting lists — don&apos;t exist in Service Autopilot. You can climb from Startup to Elite and you still won&apos;t find them. PoolBossPro was built with those features at its core.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">💰</div><h4>$129 — Not $499+</h4><p>Getting route optimization, automations, and SMS at SA costs $499+/month. PoolBossPro includes all of these at $129/month — plus the spray-specific features SA doesn&apos;t have. It&apos;s not even close on value.</p></div>
          <div className="premium-card"><div className="premium-card-icon">⚡</div><h4>No Sign-Up Fee</h4><p>SA charges a sign-up fee to get started. PoolBossPro charges $0 to sign up and offers a 14-day free trial with no credit card required. You can start today and be scheduling routes this afternoon.</p></div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Service Autopilot serves a wide range of lawn service businesses. PoolBossPro was built specifically around recurring spray routes, sq ft scheduling, and chemical compliance — the things that make lawn care and pest control operations different from general landscaping.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Sq Ft Is the Right Unit</h3><p>PoolBossPro tracks everything in square feet — waiting lists, route totals, property-level breakdown by service. SA tracks job durations and stop counts. For spray businesses, sq ft is the unit that drives pricing, routing, and capacity planning.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>No Tier-Climbing Required</h3><p>PoolBossPro gives you route optimization, automations, two-way SMS, and chemical logs at $129/month. SA starts at $49 and charges you more for each major feature until you&apos;re at $499+/month before you have what SBP includes at the entry level.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>No Sign-Up Fee. No Lock-In.</h3><p>Start a free trial right now — no credit card required, no sign-up fee. SA charges to get started and has an onboarding process. PoolBossPro is self-serve and you can be fully operational today.</p></div>
      ...
      <div className="cta-band">
        ...
        <p>Try PoolBossPro free for 14 days. No credit card required. No sign-up fee.</p>
        <div className="hero-btns">
