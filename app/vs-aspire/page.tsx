    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cost-box.sbp { background: linear-gradient(135deg, var(--purple-deep) 0%, #263445 100%); border: 2px solid rgba(13,148,136,.4); }
      ...
      <div className="hero">
        ...
        <h1>Aspire Costs $1,299/Month on Average.<br /><span>PoolBossPro Is $129. That&apos;s 10x Less — With Features Aspire Doesn&apos;t Have.</span></h1>
        <p>Aspire is an enterprise ERP built for $5M+ landscaping companies with 100+ employees. If you&apos;re a spray business, you&apos;d pay 10x more for complexity you&apos;ll never use — and still miss the spray-specific features PoolBossPro has at $129.</p>
            ...
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              <div className="cost-compare">
                ...
                <div className="cost-box sbp">
                  <div className="cost-box-label">PoolBossPro</div>
              ...
              <div className="cost-rows">
                ...
                <div className="cost-row"><span className="cost-row-label">PoolBossPro Pricing</span><span className="cost-row-val orange">$129/mo flat — published</span></div>
                ...
                <div className="cost-row"><span className="cost-row-label">PoolBossPro Trial</span><span className="cost-row-val green">14 days free — no card</span></div>
              </div>
            </div>
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              <span className="section-label">10x Less</span>
              <h2>Aspire Is an Enterprise ERP. PoolBossPro Is Built for Spray Routes. Those Aren&apos;t the Same Thing.</h2>
              ...
              <p>PoolBossPro is $129/month — designed for spray businesses running recurring treatment schedules. Lasso routing, sq ft waiting lists by service type, chemical compliance logs — these are built into PoolBossPro. They don&apos;t exist in Aspire.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">Aspire Is Built for Large Landscaping Operations. PoolBossPro Is Built for Spray Routes.</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>Aspire is a genuinely powerful platform — for the right company. It&apos;s overkill for a spray business and still misses the spray-specific features you need. PoolBossPro is purpose-built for how spray businesses actually work.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>10x Less — $1,170 Saved Every Month</h3><p>Aspire averages ~$1,299/month. PoolBossPro is $129/month. That&apos;s $1,170 saved every single month — $14,040 per year — on software that was actually built for how spray businesses operate. The savings alone pay for significant business growth.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>Built for Spray — Not Landscaping ERPs</h3><p>Aspire was designed for multi-million dollar landscaping companies with complex crew management, equipment tracking, and multi-branch operations. Spray businesses need sq ft waiting lists, lasso routing, chemical compliance logs, and recurring treatment tracking. Those features don&apos;t exist in Aspire. They&apos;re built into PoolBossPro.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>Hours to Set Up — Not Months</h3><p>Aspire requires a significant implementation and onboarding process — weeks of setup, training, and configuration before you&apos;re operational. PoolBossPro is self-serve. Start your free trial, add your clients, build your routes, and send your first estimate in a single afternoon.</p></div>
          <div className="simple-card"><div className="simple-num">04</div><h3>Month-to-Month — No Lock-In</h3><p>PoolBossPro is month-to-month from day one with a 14-day free trial. No annual contract required. No implementation fees. No credit card to start your trial. Aspire requires an annual contract and a significant upfront commitment. PoolBossPro has to earn your business every month.</p></div>
        </div>
      </section>
      ...
      <div className="cta-band">
        <h2>Why Pay $1,299/Month for Software<span>Built for a Different Industry? PoolBossPro Is $129.</span></h2>
