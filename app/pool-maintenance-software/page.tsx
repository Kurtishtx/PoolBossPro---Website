...
export default function PoolMaintenanceSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Pool Maintenance Software<br /><span>Built for How You Actually Run a Route</span></h1>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro pool maintenance software dashboard on laptop showing recurring route map and water chemistry log, with mobile app on phone"
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Live route maps, drag-and-drop stop ordering, geographic clustering, and recurring weekly schedules that rebuild themselves automatically. Dispatch your cleaning techs in tight loops so they spend the day on pools, not on the road.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Water Chemistry Logging</h4><p>Log chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate at every stop. The reading history travels with the pool, so you can spot a trend before it turns into a green pool and prove exactly what you balanced.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💬</div><h4>Communication Suite</h4><p>Two-way SMS inbox, 10+ automated alert types, &quot;your pool was serviced today&quot; texts, payment reminders, review requests &mdash; all built in at the flat price. No Twilio account, no Mailchimp, no third-party setup.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, recurring monthly billing, invoicing, charge after service, overdue reports &mdash; the full Stripe integration is wired in. Your customers can pay instantly and you see every dollar collected in one place.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔐</div><h4>Role-Based Access</h4><p>Owner, Manager, Office Staff, Technician, and Mobile-only roles. Granular permission control so your cleaning techs only see what they need and your office manager can&apos;t accidentally delete a customer record.</p></div>
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your techs get a mobile-optimized dashboard with their pools for the day. Complete, skip, reschedule, log chemistry readings, and add notes &mdash; all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a pool route we&apos;ve ever seen. Draw a circle on your service area map and PoolBossPro instantly surfaces every pool inside that radius that has a service due &mdash; with stop count, service types, and revenue all calculated in real time before you commit to a single day on the calendar.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see all pools inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops by service type: weekly clean, repair, opening</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Shows you what&apos;s already scheduled vs. what&apos;s still waiting</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>One click to dispatch all selected pools to a date and tech</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#0d9488', fontSize:'18px', fontWeight:800}}>$1,140</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Route Revenue</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#0d9488', fontSize:'18px', fontWeight:800}}>5.2 mi</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Route Distance</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Weekly Clean · 8 &nbsp;|&nbsp; Equipment Repair · 6 &nbsp;|&nbsp; Opening · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. PoolBossPro is the exception. Every screen was designed by people who ran pool routes &mdash; not UX designers who&apos;ve never carried a test kit to a back yard. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, recurring routes, map, and water chemistry log are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day is right there in a single view.'},
            {n:'03', title:'Your Techs Learn It in Minutes', body:'The mobile app your cleaning techs use shows them exactly what they need and nothing they don\'t. Their pools for the day, the equipment notes, the chemistry log, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
            {n:'04', title:'Automation Runs Without You', body:'Set up your SMS alerts, service-complete texts, and payment reminders once. After that, PoolBossPro handles every notification, every recurring visit, and every review request automatically — whether you\'re on a route, at home, or on vacation.'},
          ].map(({n, title, body}) => (
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Pool service is not plumbing. You&apos;re not sending one tech to one job once. You&apos;re running the same pools week after week, logging water chemistry at every stop, juggling repairs and green-to-clean recoveries, and billing recurring accounts on a card on file.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own pool routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to service <strong>200 pools a week</strong> and need every chlorine, pH, and cyanuric acid reading tied to the right pool &mdash; with the equipment list and the last green-to-clean right there when the tech pulls up.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Every tool in PoolBossPro was built with pool maintenance workflows in mind &mdash; not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'🔁', title:'Recurring Route Scheduling', body:'Build your weekly cleaning routes once and PoolBossPro rolls them forward automatically — same pools, same day, same tech, every week. New accounts drop into the right route the moment you add them.'},
            {icon:'📋', title:'The Job Board', body:'Every pool due for service sits on the Job Board, grouped by type — weekly clean, repair, green-to-clean, opening, or closing. See exactly what is waiting before you assign a single stop to a truck.'},
            {icon:'🗺️', title:'Live Route Map & Dispatch', body:'See every scheduled stop pinned on an interactive map. Drag to reorder, build tight geographic loops, and dispatch your techs so they cut drive time before they ever leave the shop.'},
            {icon:'🧪', title:'Water Chemistry Logging', body:'Record chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate at every visit. Readings are saved to the pool with date and tech, so you can pull a full chemistry history in seconds.'},
            {icon:'🏊', title:'Pool & Property Profiles', body:'Every pool has its own record: pool type, gallons, surface, equipment list — pump, filter, heater, salt cell — service history, chemistry logs, gate codes, photos, and notes. All tied to the address.'},
            {icon:'💧', title:'Green-to-Clean Tracking', body:'Flag a pool for green-to-clean recovery, log each treatment visit and the chemistry along the way, and track it to crystal clear. The whole recovery lives on the pool record for next time.'},
            {icon:'💬', title:'Automated Service Texts', body:'Automatically text customers when a visit is scheduled, when your tech is on the way, and when the pool has been serviced — with the readings if you want. Set it once and PoolBossPro handles every stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a repair or service estimate in minutes from your catalog, email it from the platform, and let customers accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            {icon:'💳', title:'Card-on-File & Recurring Billing', body:'Store cards on file via Stripe and bill recurring monthly pool accounts automatically. Charge after a repair, send invoices, and collect without chasing anyone down.'},
            {icon:'📱', title:'Mobile App for Technicians', body:'Your techs get a mobile-optimized view of their pools for the day. Log chemistry, mark complete, skip, or reschedule, and snap photos — right from the back yard without calling the office.'},
            {icon:'🛠️', title:'Equipment Repair Tracking', body:'Track pumps, filters, heaters, and salt systems per pool. Log repairs against the equipment record, attach parts and photos, and see the full service history for any unit at a glance.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After a completed service, PoolBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
            ...
            {icon:'🚛', title:'Truck Management', body:'Create truck profiles, assign vehicles to routes, and track which truck serviced each pool. Know exactly who was where on every route every day.'},
            ...
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards on your dashboard show today\'s revenue, pools serviced, chemistry readings logged, money owed, and more — all at a glance the moment you log in.'},
            ...
            {icon:'👥', title:'Unlimited Users', body:'Add every cleaning tech, office staff member, and repair tech at no extra cost. No per-seat fees. Unlimited users are included in the flat $129/month rate.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2>Your Recurring Routes Build Themselves &mdash; You Just Service the Pools</h2>
            <p>This is what no generic field service app gets right. PoolBossPro&apos;s recurring routes and Job Board run your week for you: weekly cleans roll forward automatically, repairs and green-to-clean jobs drop onto the board, and you dispatch the whole day from one screen. For a closer look at how the software runs the day-to-day of a pool service business, read <a href="/blogs/what-is-pool-maintenance-software" style={{color:'var(--orange)', fontWeight:600}}>What Pool Maintenance Software Actually Does for a Pool Service Business</a>.</p>
            <ul className="check-list">
              <li>Job Board grouped by service type with counts</li>
              <li>Recurring weekly routes roll forward automatically</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Equipment Repair</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 pools waiting</div></div>
              <div style={{marginLeft:'auto', background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>31 stops</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#5eead4', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Green-to-Clean</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 pools waiting</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              <div style={{color:'#0d9488', fontSize:'16px', fontWeight:700}}>Dispatch the whole day in one click.</div>
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>No other pool service software runs it like this.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemistry Logging Built for Pool Service</h2>
            <p>Every visit, your tech logs the readings that matter &mdash; and PoolBossPro saves them to the pool, not to a clipboard that gets lost. Spot a trend before a pool turns green, prove exactly what you balanced, and show any customer the history of their own water in seconds.</p>
            <ul className="check-list">
              <li>Log chlorine, pH, alkalinity, cyanuric acid per visit</li>
              <li>Track salt and phosphate for saltwater pools</li>
              <li>Record chemicals and dosages added at the stop</li>
              <li>Every reading tied to the pool, date, and technician</li>
              <li>Full chemistry history on each pool profile</li>
              <li>Filter readings by pool, customer, tech, or date range</li>
              <li>Texts can include the readings to the customer automatically</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>2.4</div>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#0d9488', fontSize:'20px', fontWeight:700}}>45</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Cyanuric (ppm)</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Maple St · 18,000 gal · Salt</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Salt 3,200 ppm · Balanced</div></div>
              <div style={{background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Clear</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#0d9488', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Oak Ln · 24,000 gal · Chlorine</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Phosphate high · Treated</div></div>
              <div style={{background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Logged</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Pool Maintenance Software — Common Questions</h2>
          {[
            {q:'Is PoolBossPro built for pool service businesses?', a:'Yes. PoolBossPro handles the full pool service operation: recurring weekly cleaning routes, water chemistry logging, green-to-clean recovery, equipment repair, pool openings and closings, estimate-to-service conversion, automated customer SMS, and card-on-file recurring payments. It is designed for companies running pool routes, not general service businesses.'},
            {q:'Can I manage multiple service types — weekly cleaning, repairs, openings — in one platform?', a:'Yes. PoolBossPro supports multiple service types from one account, with the Job Board grouped by service category. You can run weekly cleaning routes, equipment repairs, green-to-clean jobs, and seasonal openings and closings at the same time, each with its own SMS alerts and pricing.'},
            {q:'How does route building work for pool service?', a:'Recurring weekly routes roll forward automatically, so the same pools land on the same day every week. To build a new route, open the circle-map lasso tool, draw a circle around an area, and every pool due inside is selected with stop count and revenue updating in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does PoolBossPro log water chemistry?', a:'Yes. Every visit logs chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate, along with any chemicals added. Every reading is saved to the pool profile with the date and technician, so you can pull a full chemistry history for any pool in seconds.'},
            {q:'Does it replace spreadsheets and scheduling apps?', a:'Yes. PoolBossPro replaces spreadsheet scheduling, route planning, chemistry sheets, customer tracking, and SMS communication tools in one platform. Most owners are fully operational the same day they sign up — no onboarding consultant, no implementation timeline.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoolBossPro handles weekly cleaning alongside equipment repair, green-to-clean recovery, and seasonal openings and closings — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full PoolBossPro platform overview</a>.</p>
        </div>
      </section>
