    ...
    <div id={`sbp-form-${n}`} className="sbp-form">
      ...
      <div id={`sbp${n}-step1`} className="sbp-form-body">
        ...
        <div className="sbp-field">
          ...
          <input id={`sbp${n}-company`} type="text" placeholder="Smith Pool Cleaning" className="sbp-input" />
        </div>
...
export default function PoolServiceSoftware() {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">Built Specifically for Pool Cleaning</div>
        <h1>Pool Cleaning Business Software<br /><span>Built for How You Actually Run Your Routes</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. <a href="/" style={{color:'#5eead4', fontWeight:600}}>PoolBossPro</a> is built from the ground up for pool cleaning companies &mdash; the way you run recurring weekly cleaning routes, log water chemistry, dispatch crews, and bill cards on file is completely different, and your software should be too.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro pool cleaning software dashboard on laptop showing recurring route builder and water chemistry log, with mobile app on phone"
      ...
      <div className="premium-band">
        <h2>Affordable Doesn&apos;t Mean Cheap.<br /><span>This Is Enterprise-Level Pool Cleaning Software.</span></h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">The Most Capable Pool Cleaning Software Is Also the Easiest to Learn</h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Pool Cleaning</h2>
        ...
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            ...
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a pool cleaning business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and PoolBossPro is the software we always wished existed.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          <span className="section-label">Built for Pool Cleaning</span>
          <h2 className="section-title">Features Designed Around Your Operation</h2>
          <p className="section-sub">Every tool in PoolBossPro was built with pool cleaning workflows in mind &mdash; not adapted from a plumbing app and called good enough.</p>
        </div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            ...
            {q:'How much does PoolBossPro cost?', a:'$129/month, all features included. No hidden fees, no add-ons for SMS or routing, no setup fees. 14-day free trial with no credit card required.'},
          ].map(({q, a}, i, arr) => (
      ...
      <div className="cta-band">
        <h2>Stop Running Your Pool Cleaning Business<br />on Software Built for Plumbers.</h2>
        <p>PoolBossPro is the only pool cleaning management software built by someone who has actually run a recurring pool route. Try it free for 14 days.</p>
        <div className="hero-btns">
