    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro pool service software dashboard on laptop showing recurring route builder and water chemistry log, with mobile app on phone"
