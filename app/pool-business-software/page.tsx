...
export default function PoolBusinessSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Pool Business Software<br /><span>Built for How You Actually Run Routes</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. PoolBossPro is built from the ground up for pool service businesses &mdash; the way you run recurring weekly cleaning routes, log water chemistry, dispatch crews, and bill cards on file is completely different, and your software should be too.</p>
        <div className="hero-btns">
          <a href="#" onClick={(e) => { e.preventDefault(); openSignupModal(1, e.currentTarget as HTMLElement); }} className="btn-primary">Start Your 14-Day Free Trial</a>
          <div className="hero-trust">No credit card required &nbsp;&middot;&nbsp; 14-day free trial &nbsp;&middot;&nbsp; <b>$99/mo</b> after</div>
        </div>
        <div className="hero-stats">
          <div><div className="hero-stat-val">Routes</div><div className="hero-stat-lbl">Recurring Weekly Stops Per Day</div></div>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro pool service software dashboard on laptop showing recurring route map and water chemistry log, with mobile app on phone"
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Live route maps, drag-and-drop stop ordering, geographic clustering, and a recurring schedule that rolls your weekly pool cleaning stops forward automatically. Dispatch the right crew to the right pools with the least drive time.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Water Chemistry Logging</h4><p>Log chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate at every stop. PoolBossPro stores the full readings history per pool so you can spot a problem trending before it turns green.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, recurring invoicing, charge after service, payment tracking, overdue reports &mdash; the full Stripe integration is wired in. Your customers can pay instantly and you see every dollar collected in one place.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your technicians get a mobile-optimized dashboard with their pool stops for the day. Complete, skip, reschedule, log chemistry, and add notes &mdash; all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a pool route we&apos;ve ever seen. Draw a circle on your service area map and PoolBossPro instantly surfaces every pool inside that radius that&apos;s due for a cleaning &mdash; with stop count, pool types, and weekly revenue all calculated in real time before you commit to a single dispatch.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map &mdash; instantly see all pools inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops, pool types, and revenue by service automatically</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Shows you what&apos;s already scheduled vs. what&apos;s still due this week</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>One click to dispatch all selected pools to a day and a crew</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Tighten your routes geographically &mdash; no more scattered stops burning fuel</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across cleaning, repair, and recovery stops in one view</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#0d9488', fontSize:'18px', fontWeight:800}}>$2,140</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Weekly Revenue</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#0d9488', fontSize:'18px', fontWeight:800}}>3.4 mi</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Route Length</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Weekly Clean · 8 &nbsp;|&nbsp; Equipment Repair · 6 &nbsp;|&nbsp; Green-to-Clean · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. PoolBossPro is the exception. Every screen was designed by people who ran pool routes &mdash; not UX designers who&apos;ve never carried a test kit to a backyard. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            {n:'01', title:'Set Up in One Afternoon', body:'Add your services, import your customers and pool profiles, set up your automated texts, and connect Stripe — most owners are fully operational the same day they sign up. No implementation consultant, no onboarding call, no 90-day setup timeline.'},
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, the recurring route, map, and chemistry log are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day is right there in a single view.'},
            {n:'03', title:'Your Techs Learn It in Minutes', body:'The mobile app your technicians use shows them exactly what they need and nothing they don\'t. Their pool stops for the day, the property info, the equipment notes, chemistry entry, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Pool service is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re running hundreds of recurring weekly stops, logging water chemistry at every pool, handling green-to-clean recoveries and equipment repairs, and keeping a route that rolls forward every single week.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own pool routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>hundreds of pools on a recurring weekly schedule</strong> and need a clean chemistry history on every one of them &mdash; chlorine, pH, alkalinity, cyanuric, salt &mdash; right next to the equipment list.</p>
      ...
      <section>
        ...
        <div className="feature-grid">
          {[
            {icon:'🔁', title:'Recurring Route Scheduling', body:'Build a weekly cleaning route once and let it roll forward automatically. Every pool keeps its day, its frequency, and its crew — so your recurring stops are scheduled for you week after week without rebuilding anything.'},
            {icon:'🗺️', title:'Live Route Map', body:'See every scheduled pool pinned on an interactive map. Drag to reorder stops, build tight geographic routes, and cut drive time before your crew ever leaves the yard.'},
            {icon:'🧪', title:'Water Chemistry Logging', body:'Log chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate at every stop. Full readings history per pool so you can spot a trend before the water turns and prove exactly what you balanced.'},
            {icon:'🏊', title:'Pool & Property Profiles', body:'Every pool has its own record — pool type, gallons, surface, equipment list, service history, chemistry logs, gate codes, notes, and photos. Everything tied to the property, not just the customer.'},
            {icon:'🟢', title:'Green-to-Clean Recovery', body:'Track multi-visit green-to-clean recoveries as their own jobs with their own chemistry readings and progress notes. Know which pools are mid-recovery and which visit they\'re on at a glance.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when their pool is scheduled, when your tech is on the way, and when the service is done. Set it once — PoolBossPro handles the communication for every single stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a repair or service estimate in minutes from your service catalog, email it directly from the platform, and let customers accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            {icon:'💳', title:'Card-on-File Payments', body:'Store cards on file via Stripe. Bill recurring monthly service, charge after a repair, send invoices, and collect without chasing anyone down. Every dollar tracked in one place.'},
            {icon:'🔧', title:'Equipment Repair Tracking', body:'Log pumps, filters, heaters, and salt cells on each pool. Turn a repair into an estimate, dispatch it to a tech, and keep the full equipment history attached to the property forever.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After every completed service, PoolBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
            {icon:'🔁', title:'Estimate Follow-Up Sequences', body:'3 automated follow-up texts go out if a customer doesn\'t respond to your repair estimate. Let PoolBossPro chase the deal so you don\'t have to.'},
            ...
            {icon:'📄', title:'Invoice Management', body:'Convert accepted estimates to invoices instantly and bill recurring service automatically. Filter by unpaid, partial, paid, or overdue. Every dollar tracked with full payment history, method, and date.'},
            ...
            {icon:'🚛', title:'Truck & Crew Management', body:'Create truck profiles, assign crews to routes, and track which truck handled each pool. Know exactly who serviced which stop every day.'},
            {icon:'⏱️', title:'Employee Hour Tracking', body:'Track employee hours per stop and generate payroll-ready reports. Know exactly what you owe before payday without running a separate system.'},
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards on your dashboard show today\'s revenue, stops completed, pools serviced, money owed, and more — all at a glance the moment you log in.'},
            ...
            {icon:'📅', title:'Pool Openings & Closings', body:'Schedule seasonal openings and closings right alongside your recurring route. Each one carries its own checklist, chemistry readings, and equipment notes on the pool\'s record.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Pool Service Scheduling</span>
            <h2>Your Recurring Weekly Route, Built Once and Rolling Forward Forever</h2>
            <p>This is the part no generic field service software gets right. PoolBossPro&apos;s recurring schedule keeps every pool on its day, its frequency, and its crew &mdash; so your weekly cleaning route rebuilds itself automatically while the dispatch board shows you exactly what&apos;s due today. For a closer look at how the recurring route works as the daily operational hub for a pool service business, read <a href="/blogs/pool-business-software-complete-guide" style={{color:'var(--orange)', fontWeight:600}}>Pool Business Software: The Complete Guide for Pool Service Owners</a>.</p>
            <ul className="check-list">
              <li>Recurring weekly route that rolls forward automatically</li>
              <li>Dispatch directly from the route in one click</li>
              <li>Assign day, technician, and truck to every stop</li>
              <li>Full dispatch board for the day&apos;s scheduled pools</li>
              ...
              <li>Summary bar: total stops, pools, revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Today&apos;s Route — By Service Type</div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Weekly Cleaning</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 pools due today</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Equipment Repair</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>9 pools scheduled</div></div>
              <div style={{marginLeft:'auto', background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$2,465</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#5eead4', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Green-to-Clean</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>4 pools in recovery</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$1,180</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Openings &amp; Closings</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>3 pools scheduled</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$675</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              <div style={{color:'#0d9488', fontSize:'16px', fontWeight:700}}>Know your day before you roll.</div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemistry Tracking Built for Pool Service</h2>
            <p>Balanced water is the whole job. PoolBossPro makes chemistry tracking automatic &mdash; every reading is logged the moment the stop is marked complete, and the full history lives on the pool&apos;s profile so you can spot a problem trending and prove exactly what you balanced.</p>
            <ul className="check-list">
              <li>Log chlorine, pH, alkalinity, cyanuric, salt &amp; phosphate per stop</li>
              <li>Track what you added: chlorine, acid, conditioner, and more</li>
              <li>Full chemistry history charted per pool over time</li>
              <li>Tie every reading to the technician and the visit date</li>
              <li>Flag out-of-range readings before water turns green</li>
              <li>Pull a clean readings report for any customer on request</li>
              <li>Full chemical catalog with dosing notes stored in the system</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Chemistry Log — June 2026</div>
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                ...
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Stops Logged</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>134</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Pools</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#0d9488', fontSize:'20px', fontWeight:700}}>7.4</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Avg pH</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#0d9488', fontSize:'20px', fontWeight:700}}>6</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Out of Range</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>123 Oak St · Salt Pool · 18,000 gal</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Cl 3.0 · pH 7.5 · Salt 3200</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#0d9488', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>48 Maple Ct · Chlorine · 22,000 gal</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Cl 0.8 · pH 8.1 · CYA 90</div></div>
              <div style={{background:'#c2410c', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Low Cl</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <ul className="price-features">
              ...
              <li>Green-to-Clean &amp; Openings/Closings</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Pool Business Software &mdash; Common Questions</h2>
          {[
            {q:'Is PoolBossPro built for pool service businesses?', a:'Yes. PoolBossPro handles the full pool service operation: recurring weekly cleaning routes, crew dispatch and routing, water chemistry logging, green-to-clean recovery, equipment repair, estimate-to-invoice billing, automated customer SMS, and card-on-file payments. It\'s designed for companies running pool routes, not general service businesses.'},
            {q:'Can I manage cleaning, repairs, and recoveries in one platform?', a:'Yes. PoolBossPro supports multiple service types from one account — recurring cleaning, equipment repair, green-to-clean recovery, and seasonal openings and closings — each with its own scheduling and its own notes, all on the same pool profile.'},
            {q:'How does route building work for pool service?', a:'Your recurring weekly route rolls forward automatically, and the circle-map lasso lets you draw a circle around an area to dispatch every pool due inside it in one click. Stop count, pool types, and weekly revenue update in real time. Routing that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does PoolBossPro track water chemistry?', a:'Yes. Every stop logs chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate, plus what you added. The full readings history lives on each pool\'s profile so you can spot a trend before the water turns and show a customer exactly what you balanced.'},
            {q:'Does it replace spreadsheets and scheduling apps?', a:'Yes. PoolBossPro replaces spreadsheet routes, chemistry notebooks, customer tracking, invoicing, and SMS tools in one platform. Most owners are fully operational the same day they sign up — no onboarding consultant, no implementation timeline.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoolBossPro handles recurring cleaning alongside repairs, green-to-clean recovery, and seasonal openings and closings &mdash; all from one platform. New here? Start with <a href="/blogs/pool-business-software-complete-guide" style={{color:'var(--orange)', fontWeight:600}}>Pool Business Software: The Complete Guide for Pool Service Owners</a>, or head back to <a href="/" style={{color:'var(--orange)', fontWeight:600}}>PoolBossPro</a> for the full platform overview.</p>
        </div>
      </section>

      {/* CTA */}
      <div className="cta-band">
        <h2>Stop Running Your Pool Service Business<br />on Software Built for Plumbers.</h2>
        <p>PoolBossPro is the only pool service management software built by someone who has actually run a pool route. Try it free for 14 days.</p>
        <div className="hero-btns">
