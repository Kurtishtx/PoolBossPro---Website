    ...
    <>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="cat-block">
          <div className="cat-header">
            <span className="cat-icon">💰</span>
            <div><div className="cat-title">Estimates</div><div className="cat-desc">Build, send, and close estimates without leaving PoolBossPro</div></div>
          </div>
          <div className="feat-grid">
            {[
              ...
              {t:'3-Step Automated Follow-Up',d:"3 follow-up texts go out automatically if a client doesn't respond. PoolBossPro chases the deal so you don't have to."},
              {t:'Discount Codes & Sales Tax',d:'Apply percentage or flat discounts. Set tax rates and PoolBossPro calculates tax on every estimate automatically.'},
        ...
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'500 Texts/Month Included',d:'500 texts a month — sent and received — included in the $99/month. Add more in blocks of 500 for 995 each.'},
      ...
      <style>{`
        .spotlight { background: linear-gradient(135deg, #0f1720 0%, #1f2937 100%); padding: 90px 40px; }
        ...
        .dark-cat { background: linear-gradient(135deg, #0f1720 0%, #1f2937 100%); padding: 80px 40px; }
