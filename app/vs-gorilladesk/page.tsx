    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mock-dot.amber { background: #50b2a9; }
        ...
        .mock-badge.amber-badge { background: #1b9a8f; }
      ...
      <div className="hero">
        ...
        <h1>GorillaDesk Charges Per Route.<br /><span>PoolBossPro Is $129 Flat — Unlimited Routes, Unlimited Stops.</span></h1>
        <p>GorillaDesk uses a per-route pricing model — the more trucks you run, the more you pay, every month. PoolBossPro is $129/month regardless of how many routes you schedule, how many trucks you run, or how many stops you dispatch. No per-route fees. Ever.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">PoolBossPro vs GorillaDesk</h2>
      ...
      <div className="premium-band">
        <h2>GorillaDesk Charges You More Every Time You Grow.<br /><span>PoolBossPro Is $129 No Matter How Many Routes You Run.</span></h2>
        <p>GorillaDesk&apos;s per-route model sounds fine until you&apos;re running three trucks. At Basic ×3, you&apos;re at $147/month with a 25-stop cap and no two-way SMS. At Pro ×3, you&apos;re at $297/month. PoolBossPro is $129/month for your entire operation — unlimited routes, unlimited stops, every feature included. The more you grow, the more PoolBossPro saves you.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">🔁</div><h4>Unlimited Stops</h4><p>GorillaDesk Basic caps routes at 25 stops. PoolBossPro has no stop limit. Schedule 50-stop routes, 100-stop routes — no restrictions. Spray businesses run dense routes. A 25-stop cap is a real operational problem.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>GorillaDesk pricing looks reasonable for one route. The problem is what happens at 2, 3, or 5 trucks. PoolBossPro is $129 no matter how many routes you run — and includes features GorillaDesk doesn&apos;t offer at any tier.</p>
            <ul className="check-list">
              ...
              <li>PoolBossPro = $129/mo — unlimited routes, all features, forever</li>
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">PoolBossPro</div><div className="mock-sub">Unlimited routes, all features, SMS included</div></div>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>GorillaDesk Has Route Optimization. PoolBossPro Has Lasso.</h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>GorillaDesk is built for general pest control — termites, rodents, general bugs. PoolBossPro is built around lawn care and spray routes with recurring treatment schedules, sq ft tracking, and the specific way spray businesses manage their client base.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Sq Ft First — Not Just Stop Count</h3><p>PoolBossPro tracks everything in square feet — waiting list, route totals, property-level breakdown. Not just stop counts. Because lawn care and pest control pricing is based on sq ft, and your routing should be too.</p></div>
          ...
          <div className="simple-card"><div className="simple-num">04</div><h3>Price That Doesn&apos;t Scale Against You</h3><p>$129/month flat. Add routes, trucks, employees — price doesn&apos;t change. GorillaDesk&apos;s per-route model turns every growth decision into a cost increase. PoolBossPro doesn&apos;t do that.</p></div>
        </div>
      </section>
      ...
      <div className="cta-band">
        <h2>Done Paying More Every Time You Add a Truck?<br />PoolBossPro Is $129. No Matter How Many Routes You Run.</h2>
