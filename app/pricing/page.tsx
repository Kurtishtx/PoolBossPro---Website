...
const faqs = [
  { q: 'Is there really just one plan?', a: "$99/month, everything included. We don't believe in tiers that lock you out of features you need to run your business. You get the full platform from day one." },
  ...
  { q: "What's the SMS pricing?", a: 'In the US and Canada, 500 texts per month — sent and received — are included in your $99. If you go over, you can add blocks of 500 for $15 each. Most businesses with under 300 active pools never hit the 500 limit.' },
    ...
    <>
      ...
      <div style={{background:'linear-gradient(135deg,#0f1720 0%,#263445 100%)',padding:'80px 40px',textAlign:'center'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:'24px',maxWidth:'900px',margin:'0 auto'}}>
          {[
            {old:'$149/user/mo',nw:'$99 flat',desc:'Unlimited users. Add every tech and office staff at no extra cost.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div style={{textAlign:'center',maxWidth:'900px',margin:'0 auto 48px'}}>
          ...
          <p style={{color:'var(--muted)',fontSize:'17px',maxWidth:'620px',margin:'0 auto'}}>Here&apos;s exactly what you get for $99/month — nothing hidden, nothing locked behind a higher tier.</p>
        </div>
