...
export default function PoolChemicalSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Pool Chemical Tracking Software<br /><span>Built for How You Actually Work</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. PoolBossPro is built from the ground up for pool service businesses &mdash; the way you run recurring routes, test and balance water, log chemistry, and bill is completely different, and your software should be too.</p>
        <div className="hero-btns">
          <a href="#" onClick={(e) => { e.preventDefault(); openSignupModal(1, e.currentTarget as HTMLElement); }} className="btn-primary">Start Your 14-Day Free Trial</a>
        </div>
        <div className="hero-stats">
          <div><div className="hero-stat-val">Chemistry</div><div className="hero-stat-lbl">Logged on Every Stop</div></div>
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Recurring weekly route maps, drag-and-drop stop ordering, geographic clustering, and a Job Board that shows you exactly which pools are due before you dispatch a single tech. No other pool service software runs routes this tightly.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Water Chemistry Logging</h4><p>Every stop logs chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate &mdash; tied to the pool, with the dosing you added. Pull a chemistry history for any pool in seconds and prove exactly how you kept the water in balance.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, recurring invoicing, charge after service, payment tracking, overdue reports &mdash; the full Stripe integration is wired in. Your customers can pay instantly and you can see every dollar collected in one place.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your techs get a mobile-optimized dashboard with their pool stops for the day. Complete, skip, reschedule, log chemistry, and add notes &mdash; all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Dispatch — Recurring Route Builder</span>
            <h2 style={{color:'#fff'}}>Draw a Circle on the Map. Dispatch Every Pool Inside It.</h2>
            <p style={{color:'rgba(255,255,255,.65)'}}>This is the fastest way to build a pool service route we&apos;ve ever seen. Draw a circle on your service-area map and PoolBossPro instantly surfaces every pool inside that radius that&apos;s due this week &mdash; with stops, service types, and route revenue all calculated in real time before you commit to a single day.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see every pool inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops, service types, and revenue automatically</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Shows you what&apos;s already scheduled vs. what&apos;s still due</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>One click to dispatch all selected pools to a day and a tech</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Tighten your routes geographically — no more scattered stops burning fuel</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across weekly cleanings, green-to-clean, and repairs in one view</li>
          ...
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'12px'}}>Dispatch — Route Selector</div>
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#0d9488', fontSize:'18px', fontWeight:800}}>11</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Weekly Cleanings</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#0d9488', fontSize:'18px', fontWeight:800}}>$1,420</div>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Weekly Clean · 11 &nbsp;|&nbsp; Green-to-Clean · 3 &nbsp;|&nbsp; Repair · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. PoolBossPro is the exception. Every screen was designed by people who ran pool routes &mdash; not UX designers who&apos;ve never carried a test kit. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            {n:'01', title:'Set Up in One Afternoon', body:'Add your services, import your customers and pools, set up your automated alerts, and connect Stripe — most owners are fully operational the same day they sign up. No implementation consultant, no onboarding call, no 90-day setup timeline.'},
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, Job Board, map, and water chemistry log are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day is right there in a single view.'},
            {n:'03', title:'Your Techs Learn It in Minutes', body:'The mobile app your techs use shows them exactly what they need and nothing they don\'t. Their pool stops for the day, the pool profile, the chemistry fields, the job notes, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Pool service is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re running hundreds of pools on recurring weekly routes, balancing water chemistry on every stop, tracking equipment, and managing a book of accounts that never stops growing.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own pool routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>hundreds of pools on recurring weekly service</strong> and need to log chlorine, pH, and alkalinity on every single stop without slowing the tech down.</p>
      ...
      <section>
        ...
        <div className="feature-grid">
          {[
            {icon:'🔁', title:'Recurring Route Scheduling', body:'Set a pool on a weekly, biweekly, or custom recurring schedule once, and PoolBossPro builds the route forever. The Job Board shows every pool due so nothing on your book gets skipped.'},
            {icon:'🗺️', title:'Live Route Map & Dispatch', body:'See every scheduled pool pinned on an interactive map. Drag to reorder stops, build tight geographic routes, and cut drive time before your tech ever leaves the yard.'},
            {icon:'🧪', title:'Water Chemistry Logging', body:'Log chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate on every stop, with the chemicals and dosing you added. Pull a full chemistry history for any pool in seconds.'},
            {icon:'💧', title:'Green-to-Clean Recovery', body:'Track green-pool recovery jobs from the first acid wash or shock through repeat visits. Log readings at each stage and show the customer exactly how the water came back to clear.'},
            {icon:'📋', title:'The Job Board', body:'Every pool that\'s due shows up on one Job Board — weekly cleanings, green-to-clean, repairs, openings, and closings. See the whole day at a glance and dispatch it in a couple of clicks.'},
            {icon:'💬', title:'Automated Customer Texts', body:'Automatically text customers when a tech is on the way, when service is done, and when chemistry is logged. Set it once — PoolBossPro handles the communication for every single stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a pool repair or service estimate in minutes from your catalog, email it directly from the platform, and let customers accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            {icon:'💳', title:'Card-on-File Payments', body:'Store cards on file via Stripe. Auto-bill recurring weekly service, charge after repairs, send invoices, and collect without chasing anyone down. Every dollar tracked in one place.'},
            {icon:'🏊', title:'Pool & Property Profiles', body:'Every pool has its own record — pool type, gallons, surface, equipment, gate codes, chemistry history, notes, GPS, and photos. Everything tied to the pool, not just the customer.'},
            {icon:'⚙️', title:'Equipment & Repair Tracking', body:'Log pumps, filters, heaters, and salt systems on each pool. Track repair jobs, parts, and warranties so you know exactly what equipment is on every property before the tech arrives.'},
            {icon:'📅', title:'Openings & Closings', body:'Schedule seasonal pool openings and closings right alongside your recurring routes. Build a checklist per job and bill it the moment the tech marks it complete.'},
            {icon:'📱', title:'Mobile App for Technicians', body:'Your techs get a mobile-optimized view of their pool stops for the day. Log chemistry, mark jobs complete, skip, or reschedule — right from the truck without calling the office.'},
            ...
            {icon:'🔁', title:'Estimate Follow-Up Sequences', body:'3 automated follow-up texts go out if a customer doesn\'t respond to your estimate. Let PoolBossPro chase the deal so you don\'t have to.'},
            ...
            {icon:'📄', title:'Invoice Management', body:'Convert accepted estimates to invoices instantly and auto-bill recurring service. Filter by unpaid, partial, paid, or overdue — every dollar tracked with full payment history, method, and date.'},
            ...
            {icon:'🚛', title:'Truck Management', body:'Create truck profiles, assign vehicles to routes, and track which truck serviced each pool. Know exactly what\'s on every truck every day.'},
            ...
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards on your dashboard show today\'s revenue, pools serviced, chemistry logged, money owed, and more — all at a glance the moment you log in.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2>Know Exactly Which Pools Are Due Before You Dispatch a Single Tech</h2>
            <p>This is the feature no other pool service software has. PoolBossPro&apos;s Job Board doesn&apos;t just show you what pools need service &mdash; it groups everything that&apos;s due by service type so you know exactly how much work you can fit in a day before you build the route. For a closer look at how chemistry logging and the Job Board work together as the daily operational hub for a pool service business, read <a href="/blogs/pool-chemical-tracking-software-complete-guide" style={{color:'var(--orange)', fontWeight:600}}>Pool Chemical Tracking Software: The Complete Guide for Pool Service Businesses</a>.</p>
            <ul className="check-list">
              <li>Job Board grouped by service type with due-now counts</li>
              ...
              <li>Summary bar: total stops, services, revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Weekly Cleaning</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 pools due</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Green-to-Clean</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>9 pools in recovery</div></div>
              <div style={{marginLeft:'auto', background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>9 stops</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#5eead4', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Equipment Repair</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>14 pools scheduled</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Openings &amp; Closings</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>6 pools queued</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>6 stops</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              <div style={{color:'#0d9488', fontSize:'16px', fontWeight:700}}>Know before you dispatch.</div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Balanced water is the whole job. PoolBossPro makes chemistry tracking automatic &mdash; every reading is logged the moment the tech finishes the stop, tied to the pool, so you can pull a full chemistry history for any account in seconds and prove exactly how you kept the water in balance.</p>
            <ul className="check-list">
              <li>Log chlorine, pH, alkalinity, cyanuric, salt &amp; phosphate per stop</li>
              <li>Record the chemicals and dosing added at each visit</li>
              <li>Tied to the pool profile: type, gallons, and equipment</li>
              <li>Track technician and time on every reading</li>
              <li>Filter chemistry history by pool, tech, or date range</li>
              <li>Spot trends before a pool turns — catch problems early</li>
              <li>Full chemical catalog with dosing stored in the system</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                ...
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Readings Logged</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>134</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Pools Serviced</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#0d9488', fontSize:'20px', fontWeight:700}}>3.1</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Avg Free Chlorine</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Maple St · Chlorine 3.0 · pH 7.5</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · CYA 40 · Alk 100</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#0d9488', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Oak Ln · Salt 2,900 · pH 7.8</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Phosphate 200</div></div>
              <div style={{background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>+2 lb acid</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Pool Service Software — Common Questions</h2>
          {[
            {q:'Is PoolBossPro built for pool service businesses?', a:'Yes. PoolBossPro handles the full pool service operation: recurring weekly route scheduling, water chemistry logging, green-to-clean recovery, equipment repair tracking, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running recurring pool routes, not general service businesses.'},
            {q:'Can I manage multiple service types — weekly cleaning, repairs, openings — in one platform?', a:'Yes. PoolBossPro supports multiple service types from one account, with a Job Board grouped by service category. You can run weekly cleanings, green-to-clean recovery, equipment repairs, and seasonal openings and closings simultaneously with service-specific SMS alerts and independent pricing.'},
            {q:'How does route building work for pool service?', a:'You open the circle-map dispatch tool, draw a circle around a geographic area, and every pool due inside is selected and added to your route. Stop count, service types, and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Does PoolBossPro track water chemistry?', a:'Yes. Every stop logs chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate, along with the chemicals and dosing the tech added. The chemistry history is tied to each pool profile, so you can pull a complete record for any account in seconds and catch a pool that\'s trending out of balance before it turns.'},
            {q:'Does it replace spreadsheets and scheduling apps?', a:'Yes. PoolBossPro replaces spreadsheet scheduling, route planning, paper chemistry sheets, customer tracking, and SMS communication tools in one platform. Most owners are fully operational the same day they sign up — no onboarding consultant, no implementation timeline.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoolBossPro handles recurring weekly cleaning alongside green-to-clean recovery, equipment repair, and seasonal openings and closings — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full PoolBossPro platform overview</a>.</p>
        </div>
      </section>
