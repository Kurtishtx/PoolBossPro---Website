    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sbp-contrast { background: linear-gradient(135deg, var(--purple-deep) 0%, #263445 100%); border-radius: 10px; padding: 20px 18px; border: 2px solid rgba(13,148,136,.3); }
      ...
      <div className="hero">
        ...
        <h1>Housecall Pro Is Built for Plumbers and HVAC.<br /><span>PoolBossPro Is Built for Spray.</span><br />$129 vs $149 — and No Comparison on Features.</h1>
        <p>Housecall Pro serves cleaning companies, plumbers, HVAC techs, and dozens of other trades. PoolBossPro is built specifically for lawn care and pest control — with the sq ft waiting list, chemical compliance logs, lasso route selector, and recurring treatment tracking that HCP doesn&apos;t have at any price.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">Unlimited</div><div className="hero-stat-lbl">Users on PoolBossPro ($129/mo)</div></div>
          <div><div className="hero-stat-val">$149</div><div className="hero-stat-lbl">HCP Essentials — 5-User Cap</div></div>
          <div><div className="hero-stat-val">$129</div><div className="hero-stat-lbl">PoolBossPro — Unlimited Users</div></div>
        </div>
      </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">HCP Charges More Per Tier. PoolBossPro Is $129 — Unlimited.</h2>
          <p className="section-sub" style={{marginLeft:'auto', marginRight:'auto'}}>Housecall Pro structures pricing around user count. The moment you need more than one user, your price jumps. PoolBossPro doesn&apos;t have user tiers — your whole team is included at $129/month.</p>
        </div>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-contrast">
                <div className="sbp-contrast-label">PoolBossPro — $129/month</div>
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <h2>At the Same Price as HCP Essentials, PoolBossPro Has Features HCP Doesn&apos;t Have at Any Price.</h2>
              <p>HCP Essentials is $149/month and covers up to 5 users. PoolBossPro is $129/month with unlimited users. But the bigger gap isn&apos;t price — it&apos;s features. HCP doesn&apos;t have a sq ft waiting list, a lasso circle route selector, or dedicated chemical compliance logs. These aren&apos;t premium add-ons in PoolBossPro — they&apos;re in the base price.</p>
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Users at $129</h4><p>HCP Basic is 1 user. HCP Essentials caps at 5 users for $149. PoolBossPro covers your entire team at $129 — no user caps, no tier jumps, no per-seat math as you hire. Add your 10th employee at no extra cost.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔁</div><h4>Recurring Treatment Model</h4><p>PoolBossPro is built around recurring service programs — waiting lists, treatment cycles, package renewals, due-date flags. HCP handles recurring jobs for general trades. The spray-specific workflow is different, and HCP wasn&apos;t built for it.</p></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">PoolBossPro vs Housecall Pro</h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Housecall Pro does many things well for general home service companies. PoolBossPro does fewer things — but all of them are the exact things a spray business needs, built deeper and better than any general platform.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Sq Ft Is the Unit That Matters</h3><p>PoolBossPro tracks everything in square feet — waiting lists, route totals, property breakdowns, billing. Lawn care and pest control pricing is sq ft based. Your software should be too. HCP tracks job duration and billing, not sq ft.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>The Spray Route Model Is Different</h3><p>Spray businesses run recurring treatment schedules across hundreds of properties. That&apos;s a different operating model than one-off plumbing calls or cleaning visits. PoolBossPro was built around the spray model from day one.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>Chemical Compliance Isn&apos;t Optional</h3><p>Pesticide applicators are subject to state compliance requirements. Chemical application logs, product records, license tracking — these need to be built into the software. HCP has job notes. PoolBossPro has compliance logs.</p></div>
          <div className="simple-card"><div className="simple-num">04</div><h3>$20 Less — And More Included</h3><p>PoolBossPro is $129/month with unlimited users, unlimited routes, chemical logs, lasso, sq ft waiting list, and SMS. HCP Essentials is $149 with a 5-user cap and none of those spray-specific features. Less money. More spray.</p></div>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>Try PoolBossPro free for 14 days. No credit card required. Set up in an afternoon.</p>
        <div className="hero-btns">
