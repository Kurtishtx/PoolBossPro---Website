  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>ServiceTitan Is Built for HVAC and Plumbing.<br /><span>PoolBossPro Is Built for Lawn Care.</span></h1>
      ...
      <section>
        <div className="centered" style={{maxWidth:'900px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">PoolBossPro vs ServiceTitan</h2>
          <p className="section-sub">ServiceTitan is built for enterprise HVAC. PoolBossPro is built for lawn care and pest control.</p>
        </div>
      ...
      <div className="premium-band">
        <h2>ServiceTitan Was Built for $5M+ HVAC Companies.<br /><span>PoolBossPro Was Built for Spray Routes.</span></h2>
        <p>ServiceTitan is one of the most powerful field service platforms in the world. It&apos;s also one of the most expensive, most complex, and most overkill tools you could choose for a lawn care or pest control business. You&apos;d spend 90 days implementing it, pay $300–$500+/month, and still be missing features built specifically for spray businesses. PoolBossPro is $129, set up in an afternoon, and built around how your routes actually work.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">⚡</div><h4>Up in a Day, Not 90</h4><p>ServiceTitan implementations take months. You&apos;ll need an onboarding team, configuration calls, and a lot of patience. PoolBossPro is designed for owners who want to be operational today — not next quarter.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💰</div><h4>$129 vs $300–500+</h4><p>ServiceTitan pricing is custom, but independent estimates consistently put it at $300–$500+ per month for small operations — before add-ons. PoolBossPro is $129/month. No negotiation, no annual contract, no surprise invoices.</p></div>
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">PoolBossPro</div><div className="mock-sub">Every feature — built for spray routes</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px'}}>
              <div style={{color:'var(--orange)', fontSize:'13px', fontWeight:700, marginBottom:'8px'}}>PoolBossPro also includes things ST doesn&apos;t:</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>ServiceTitan implementations take months, require training, and need ongoing support. PoolBossPro is designed for spray business owners who want to be running today — not next quarter after a paid onboarding engagement.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>No Onboarding Team Required</h3><p>PoolBossPro is designed to be self-serve from day one. Add your services, import your clients and properties, connect your payment processor, and you&apos;re scheduling. No implementation consultant, no 90-day setup timeline.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>Pricing You Can Plan Around</h3><p>$129/month. No custom quotes, no sales calls, no contract negotiations. ServiceTitan won&apos;t even give you pricing without a demo — because their pricing is based on your revenue. PoolBossPro is $129. Always.</p></div>
          ...
          <div className="simple-card"><div className="simple-num">04</div><h3>Cancel Anytime — No Lock-In</h3><p>No annual contract required. Month to month from day one. ServiceTitan requires annual agreements that lock you in regardless of how the software performs. PoolBossPro earns your business every month.</p></div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">ServiceTitan won&apos;t tell you their price until you sit through a demo. PoolBossPro is $129. Right here, right now.</p>
        </div>
      ...
      <div className="cta-band">
        ...
        <p>Try PoolBossPro free for 14 days. Set up in an afternoon. $129/month — no sales call required.</p>
        <div className="hero-btns">
