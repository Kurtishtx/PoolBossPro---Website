    ...
    <>
        ...
        <div className="navbar-inner">
          <div className="navbar-brand">
            <a href="/" style={{textDecoration:'none', display:'flex', alignItems:'center', gap:'8px'}}>
              {/* The BossPro crown in PoolBossPro's own colours, rather than a stock emoji. */}
          ...
          <div className="navbar-links">
            ...
            <a href="https://my.poolbosspro.com/demo.html" className="navbar-demo" style={{display:'inline-flex', alignItems:'center', gap:'7px', border:'1.5px solid rgba(255,255,255,.35)', borderRadius:'6px', padding:'9px 16px', fontSize:'14px', fontWeight:700, color:'#fff', textDecoration:'none', whiteSpace:'nowrap'}}>
          ...
          <a
            href="https://my.poolbosspro.com/demo.html"
      ...
      {open && (
        <div className="nav-mobile-menu">
          ...
          <a href="https://my.poolbosspro.com/demo.html" className="nav-mobile-link" onClick={() => toggleMenu(false)}>▶ Try the Live Demo — no signup</a>
          <button
