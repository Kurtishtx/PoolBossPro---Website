  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>Most field service software is built for plumbers and HVAC techs. PoolBossPro is built from the ground up for lawn care businesses — the way you schedule, route, track, and bill is completely different, and your software should be too.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro lawn care software dashboard on laptop showing circle-map route builder and waiting list, with mobile app on phone"
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a lawn care route we&apos;ve ever seen. Draw a circle on your service area map and PoolBossPro instantly surfaces every property inside that radius that has a service due — with total square footage, service types, stops, and revenue all calculated in real time before you commit to a single schedule.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. PoolBossPro is the exception. Every screen was designed by people who ran lawn care routes — not UX designers who&apos;ve never touched a spray rig. Your team will be using it confidently on day one.</p>
        </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        ...
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            ...
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a lawn care business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and PoolBossPro is the software we always wished existed.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in PoolBossPro exists because we needed it on a real lawn care route. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Every tool in PoolBossPro was built with lawn care workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Sq Ft Waiting List', body:'Before you schedule a single stop, PoolBossPro shows you the exact square footage waiting for every service type on your list. Know how much Lawn Care 4, Mosquito, or Insect Control you can fit in a day before you make a single call.'},
            ...
            {icon:'📦', title:'Lawn Care Package Programs', body:'Create 6-application or custom package programs, assign clients to them, and track renewal dates. PoolBossPro alerts you when packages are coming due so nothing falls through the cracks.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when a service is scheduled, when your tech is on the way, and when the job is done. Set it once — PoolBossPro handles the communication for every single stop.'},
            ...
            {icon:'🔁', title:'Estimate Follow-Up Sequences', body:'3 automated follow-up texts go out if a client doesn\'t respond to your estimate. Let PoolBossPro chase the deal so you don\'t have to.'},
            ...
            {icon:'🏢', title:'Unlimited Clients & Properties', body:'No caps on clients, properties, or leads. Whether you have 50 accounts or 5,000 — PoolBossPro handles it all at the same flat price.'},
          ].map(({icon, title, body}) => (
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Every state requires pesticide application records. PoolBossPro makes compliance automatic — every application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">We were paying $500–$700 a month for software that nickel-and-dimed us. We built PoolBossPro to be the pricing we always wished existed.</p>
        </div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Is PoolBossPro built for lawn care businesses?', a:'Yes. PoolBossPro handles the full lawn care operation: recurring program scheduling, sq ft-based route building, chemical application logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running treatment routes, not general service businesses.'},
            {q:'Can I manage multiple service types — lawn care, weed control, fertilizer — in one platform?', a:'Yes. PoolBossPro supports multiple service types from one account, with separate waiting lists by service category. You can run lawn care, weed control, fertilizer, and pest control routes simultaneously with service-specific SMS alerts and independent pricing.'},
            ...
            {q:'Does PoolBossPro track chemical applications for lawn care?', a:'Yes. Every treatment logs the product, EPA registration number, rate, and area treated. The chemical compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Does it replace spreadsheets and scheduling apps?', a:'Yes. PoolBossPro replaces spreadsheet scheduling, route planning, customer tracking, and SMS communication tools in one platform. Most owners are fully operational the same day they sign up — no onboarding consultant, no implementation timeline.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoolBossPro handles lawn care alongside weed control, fertilizer, pest control, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>PoolBossPro is the only lawn care management software built by someone who has actually run a spray route. Try it free for 14 days.</p>
        <div className="hero-btns">
