  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Spraye Caps Your Properties and Charges Per User.<br /><span>PoolBossPro Is $129 Flat. No Limits.</span></h1>
        <p>Spraye caps your property count and charges per user on top of their base subscription. PoolBossPro is $129/month — unlimited properties, unlimited users, no setup fee, no demo required. Start today.</p>
        ...
        <div className="hero-stats">
          <div><div className="hero-stat-val">$129</div><div className="hero-stat-lbl">PoolBossPro — Flat Monthly</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">PoolBossPro vs Spraye</h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">Spraye Is $229.97–$299.99+/Month Before Per-User Fees. PoolBossPro Is $129. Flat.</h2>
          <p className="section-sub" style={{maxWidth:'720px', marginLeft:'auto', marginRight:'auto'}}>Spraye&apos;s pricing isn&apos;t just higher than SBP — it grows as you add users. PoolBossPro is $129/month for your entire team, every feature, no property caps, no setup fee, forever.</p>
        </div>
        <div style={{maxWidth:'1100px', margin:'0 auto'}}>
          <div className="highlight-row">
            <div className="highlight-visual-dark" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="mock-item"><div className="mock-dot orange"></div><div><div className="mock-label">PoolBossPro</div><div className="mock-sub">Unlimited users, unlimited properties, every feature</div></div><div className="mock-badge">$129/mo</div></div>
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <h2>PoolBossPro Is $129. That&apos;s Everything. No Add-Ons. No Caps. No Setup Fee.</h2>
              <p>Spraye&apos;s base subscription doesn&apos;t include everything — you add users on top of it, pay a setup fee to get started, and need to book a demo before you can even begin. PoolBossPro starts with a free trial and one price that covers your entire operation.</p>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>Spraye Has Map Scheduling. PoolBossPro Has Lasso.</h2>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Spraye requires a demo before you can get started. PoolBossPro has a 14-day free trial you can start right now — no credit card, no demo call, no setup fee, no waiting for a callback.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Start Without a Demo</h3><p>PoolBossPro is self-serve from day one. No demo required, no sales call, no waiting for a rep to call you back. Sign up, start your free trial, and be scheduling routes the same afternoon.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>No Setup Fee. Ever.</h3><p>$0 to get started. PoolBossPro charges no setup fee, no onboarding fee, no implementation cost. Spraye charges a setup fee before you can use the software. PoolBossPro just charges $129/month.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>One Price — No Per-User Math</h3><p>$129/month for your entire team. Add your 5th employee, your 10th — price doesn&apos;t change. Spraye charges per user on top of their base subscription, which means every hire increases your bill. PoolBossPro doesn&apos;t.</p></div>
      ...
      <div className="cta-band">
        ...
        <p>Try PoolBossPro free for 14 days. No credit card required. No demo needed.</p>
        <div className="hero-btns">
