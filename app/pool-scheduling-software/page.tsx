...
export default function PoolSchedulingSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Pool Scheduling Software<br /><span>Built for How Pool Routes Actually Run</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. PoolBossPro is built from the ground up for pool service businesses &mdash; recurring weekly cleaning routes, water chemistry logging, green-to-clean recovery, and equipment repair work the way you actually run it. Your scheduling software should understand recurring stops and chemistry readings, not just one-off service calls.</p>
        <div className="hero-btns">
          <a href="#" onClick={(e) => { e.preventDefault(); openSignupModal(1, e.currentTarget as HTMLElement); }} className="btn-primary">Start Your 14-Day Free Trial</a>
        </div>
        <div className="hero-stats">
          <div><div className="hero-stat-val">Routes</div><div className="hero-stat-lbl">Recurring Weekly Stops Auto-Built</div></div>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro pool scheduling software dashboard on laptop showing recurring route map and water chemistry log, with mobile app on phone"
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Recurring weekly routes that rebuild themselves, drag-and-drop stop ordering, geographic clustering, and a Job Board that shows every pool due before you dispatch a single truck. Tighten routes so your techs aren&apos;t crossing town between stops.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🧪</div><h4>Water Chemistry Logging</h4><p>Every visit logs chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate readings tied to the pool. Track dosing, spot trends across visits, and pull a clean chemistry history for any account in seconds.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💬</div><h4>Communication Suite</h4><p>Two-way SMS inbox, 10+ automated alert types, on-my-way texts, payment reminders, review requests &mdash; all built in at the flat price. No Twilio account, no Mailchimp, no third-party setup.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, recurring billing, invoicing, charge after service, and overdue reports &mdash; the full Stripe integration is wired in. Your customers can pay instantly and you see every dollar collected in one place.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your techs get a mobile dashboard with the day&apos;s pools. Complete, skip, reschedule, log chemistry readings, snap photos, and add notes &mdash; all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a pool route we&apos;ve ever seen. Draw a circle on your service area map and PoolBossPro instantly surfaces every pool inside that radius with a visit due &mdash; with stop count, service types, and route revenue all calculated in real time before you commit to a single dispatch.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see all pools inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops and service types automatically</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Shows you what&apos;s already scheduled vs. what&apos;s still due</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>One click to dispatch all selected pools to a date and truck</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Tighten your routes geographically — no more scattered stops burning fuel</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across cleaning, repair, and recovery visits in one view</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                ...
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Pools Due</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Weekly Clean · 11 &nbsp;|&nbsp; Equipment Repair · 4 &nbsp;|&nbsp; Green-to-Clean · 4</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. PoolBossPro is the exception. Every screen was designed by people who ran pool routes &mdash; not UX designers who&apos;ve never tested a drop of water. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, Job Board, route map, and chemistry log are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day is right there in a single view.'},
            {n:'03', title:'Your Techs Learn It in Minutes', body:'The mobile app your techs use shows them exactly what they need and nothing they don\'t. Their pools for the day, the chemistry fields, the pool details, the job notes, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Pool service is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re running recurring weekly routes across hundreds of pools, logging water chemistry on every visit, juggling green-to-clean recovery and equipment repairs, and billing the same accounts month after month.</p>
        </div>
      ...
      <section>
        ...
        <div className="feature-grid">
          {[
            {icon:'🔁', title:'Recurring Route Scheduling', body:'Build a weekly cleaning route once and PoolBossPro rebuilds it automatically every cycle. Each pool keeps its day, frequency, and assigned tech so recurring stops never fall off the schedule.'},
            {icon:'📋', title:'The Job Board', body:'Every pool due for a cleaning, repair, opening, or closing lands on the Job Board. See what\'s waiting, what\'s assigned, and what\'s still open before you dispatch a single truck.'},
            ...
            {icon:'🧪', title:'Water Chemistry Logging', body:'Log chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate on every visit. Readings tie to the pool so you can spot trends and prove the water was balanced.'},
            {icon:'🚐', title:'Crew Dispatch & Routing', body:'Assign pools to techs and trucks, order the route, and send the day out. Your crew sees their stops in sequence and you see exactly who\'s where.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when a visit is scheduled, when your tech is on the way, and when the pool is done. Set it once — PoolBossPro handles the communication for every stop.'},
            {icon:'💰', title:'Estimates That Close', body:'Build a repair or green-to-clean estimate in minutes from your service catalog, email it from the platform, and let customers accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            ...
            {icon:'📱', title:'Mobile App for Technicians', body:'Your techs get a mobile view of the day\'s pools. Mark visits complete, log chemistry, snap photos, skip, or reschedule — right from the truck without calling the office.'},
            {icon:'🏊', title:'Pool & Property Profiles', body:'Every pool has its own record — pool type, size in gallons, surface, equipment, gate codes, chemistry history, notes, and photos. Everything tied to the property, not just the customer.'},
            ...
            {icon:'🔧', title:'Equipment Repair Tracking', body:'Log pumps, filters, heaters, and salt cells per pool. Track repair history and parts so you walk up to the equipment pad already knowing what\'s installed.'},
            {icon:'🟢', title:'Green-to-Clean Jobs', body:'Track recovery jobs separately from recurring cleanings, with their own pricing, visit notes, and chemistry progress so you can prove the turnaround and bill for the work.'},
            ...
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards show today\'s revenue, visits completed, pools serviced, money owed, and more — all at a glance the moment you log in.'},
            {icon:'🔔', title:'10+ Automated Alert Types', body:'Visit scheduled, completed, skipped, rescheduled, estimate sent, estimate accepted, review request, payment declined, inbound text — all automated, all customizable.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Pool Scheduling</span>
            <h2>Build Your Recurring Route Once. Let It Run Every Week.</h2>
            <p>This is the feature no other pool service software gets right. PoolBossPro&apos;s Job Board doesn&apos;t just show you which pools need service today &mdash; it knows the recurring weekly cleanings, the repairs, and the green-to-clean recoveries, and keeps them flowing onto the right day and the right truck automatically. For a deeper look at how recurring scheduling and the Job Board run the daily operation of a pool service business, read <a href="/blogs/pool-scheduling-software-complete-guide" style={{color:'var(--orange)', fontWeight:600}}>Pool Scheduling Software: The Complete Guide for Pool Service Businesses</a>.</p>
            <ul className="check-list">
              <li>Recurring weekly cleaning routes rebuild automatically</li>
              <li>Job Board grouped by service type — clean, repair, recovery</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$5,170</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#0d9488', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Equipment Repair</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>9 pools due</div></div>
              <div style={{marginLeft:'auto', background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$3,240</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#5eead4', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Green-to-Clean</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>6 pools in recovery</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$2,850</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Openings & Closings</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 pools booked</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$3,975</div>
            </div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Chemistry Logging Built for How Pool Techs Actually Test</h2>
            <p>Balanced water is the whole job. PoolBossPro makes chemistry tracking automatic &mdash; every reading is logged the moment the visit is marked complete, tied to the pool, so you can prove the water was right and catch a problem before it turns a pool green.</p>
            <ul className="check-list">
              <li>Log chlorine, pH, alkalinity, cyanuric, salt, and phosphate</li>
              <li>Record dosing — what you added and how much</li>
              <li>Readings tie to the pool, not buried in a note</li>
              <li>Track the tech who performed each test</li>
              <li>Spot trends across visits to flag a struggling pool</li>
              <li>Pull a clean chemistry history for any account in seconds</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>2.8</div>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#0d9488', fontSize:'20px', fontWeight:700}}>110</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Alkalinity (ppm)</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#0d9488', fontSize:'20px', fontWeight:700}}>3,200</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Salt (ppm)</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Maple Dr · 18,000 gal · Salt</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · CYA 45 · Balanced</div></div>
              <div style={{background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>In Range</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#0d9488', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Oak Ln · 24,000 gal · Chlorine</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · pH high · Added acid</div></div>
              <div style={{background:'#0d9488', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Dosed</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <ul className="price-features">
              ...
              <li>Pool Profiles &amp; Equipment Tracking</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Pool Scheduling Software — Common Questions</h2>
          {[
            {q:'Is PoolBossPro built for pool service businesses?', a:'Yes. PoolBossPro handles the full pool service operation: recurring weekly cleaning routes, water chemistry logging, green-to-clean recovery, equipment repair, pool openings and closings, estimate-to-invoice conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running recurring pool routes, not general service businesses.'},
            {q:'How does recurring scheduling work for weekly pool cleaning?', a:'You set each pool\'s service day, frequency, and assigned tech once. PoolBossPro then rebuilds the route every cycle so your weekly cleanings flow onto the right day and the right truck automatically. The Job Board shows everything due — cleanings, repairs, and recoveries — before you dispatch.'},
            {q:'Can I log water chemistry on every visit?', a:'Yes. Every visit lets your tech log chlorine, pH, alkalinity, cyanuric acid, salt, and phosphate, plus what was dosed. Readings tie to the pool so you can spot trends across visits and pull a clean chemistry history for any account in seconds.'},
            {q:'How does route building and dispatch work?', a:'Open the circle-map lasso tool, draw a circle around an area, and every pool due inside is selected and added to your route with stop count and revenue updating in real time. Then assign the date, tech, and truck and send the day out. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'Can I track equipment and green-to-clean jobs?', a:'Yes. Every pool profile stores type, gallons, surface, and equipment like pumps, filters, heaters, and salt cells. Green-to-clean recovery jobs are tracked separately from recurring cleanings with their own pricing, notes, and chemistry progress so you can prove the turnaround and bill for the work.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoolBossPro handles recurring cleaning routes alongside equipment repair, green-to-clean recovery, and pool openings and closings &mdash; all from one platform &mdash; <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full PoolBossPro platform overview</a>.</p>
        </div>
      </section>
