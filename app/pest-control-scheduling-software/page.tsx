  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>PoolBossPro is scheduling software for pest control companies running recurring programs. Every customer&#39;s next treatment auto-schedules when the previous one is completed. Build Lasso circle routes, log EPA reg numbers and application rates on every job, and send automated SMS alerts without your team ever touching a text message. $129/month, everything included.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="PoolBossPro pest control scheduling software showing the dispatch board, recurring program waiting list, and technician mobile app"
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <p className="section-sub">PoolBossPro handles the scheduling, routing, compliance logging, and automated SMS alerts for every recurring pest control program your company runs — with auto-rescheduling after every treatment so your waiting list stays accurate all year without anyone managing it manually.</p>
        </div>
        <div className="audience-grid">
          <div className="audience-card">
            <div className="audience-tag">Quarterly Programs</div>
            <h3>Quarterly Pest Control — 4 Treatments Per Year</h3>
            <p>PoolBossPro auto-schedules each quarterly treatment approximately 13 weeks after the previous one completes. Your waiting list stays accurate year-round without your office ever manually scheduling a single follow-up visit between quarterly rounds for any customer.</p>
          </div>
          <div className="audience-card">
          ...
          <div className="audience-card">
            ...
            <p>Monthly pest control programs are the highest-frequency scheduling challenge. PoolBossPro manages monthly recurrence automatically — 12 treatments per customer per year, each auto-scheduled 4 weeks after the previous. Your waiting list shows every monthly treatment due each day without any manual scheduling.</p>
          </div>
          <div className="audience-card">
            <div className="audience-tag">Mosquito Add-On</div>
            <h3>Mosquito Add-On for Existing Pest Control Customers</h3>
            <p>Many pest control companies add mosquito programs to existing quarterly or bi-monthly customers. PoolBossPro tracks both services under the same customer account — each on its own schedule, its own compliance log, its own SMS template — without mixing them together in a confusing combined schedule.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Open Lasso on the map, draw a circle around any neighborhood or service zone, and PoolBossPro instantly shows you every property with a pest control treatment due inside that boundary — program type, stop count, and total route revenue — before you commit to building the route.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>PoolBossPro sends a day-before service reminder the evening before every pest control visit, an on-the-way alert when the tech is headed to the property, and a service complete notification with re-entry interval automatically when the compliance log is saved. Your technicians never touch a text message. Your office never follows up after a job.</p>
          ...
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.45)', fontSize:'10px', textTransform:'uppercase', letterSpacing:'.8px', marginBottom:'14px'}}>Pest Control SMS Thread — Sent Automatically by PoolBossPro</div>
      ...
      <div className="premium-band">
        ...
        <p>PoolBossPro isn&#39;t a generic job board adapted for pest control. Recurring program auto-rescheduling, compliance logs, Lasso circle route building, and automated SMS alerts are built specifically for pest control companies running quarterly, bi-monthly, and monthly programs at scale.</p>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does PoolBossPro handle recurring pest control scheduling?', a:'Yes. PoolBossPro manages quarterly, bi-monthly, monthly, and custom-interval pest control programs. When a treatment is completed, the next one is automatically placed back on the waiting list at the correct interval — no manual rebooking, no calendar entry.'},
            ...
            {q:'Can I manage both residential and commercial pest control accounts?', a:'Yes. PoolBossPro stores property details, service notes, and treatment history for any account type. Commercial accounts can have separate service areas with independent treatment logs, and their program intervals can differ from residential customers.'},
            {q:'Does it send automated service notifications?', a:'Yes. PoolBossPro sends automated SMS alerts at each step: appointment reminders, on-the-way notifications, and completion messages including re-entry interval if needed. Alerts are configured once per service type and fire automatically on every job.'},
            {q:'Can I track renewals and know which customers are coming up for renewal?', a:'Yes. PoolBossPro shows treatments remaining on each customer\'s program. You can run a report to identify renewal candidates approaching the end of their contract — so you can initiate renewal conversations before the program lapses.'},
            {q:'What does PoolBossPro cost?', a:'$129/month for everything. No per-user fees, no SMS add-ons, no extra charge for compliance logs or route tools. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoolBossPro is pest control scheduling software built for recurring programs — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a> to learn what's included.</p>
        </div>
      </section>
